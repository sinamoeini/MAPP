...
{
    /*
    T[1][1]-=H[1][0]*T[1][0]/H[0][0];
    
    T[2][2]+=-H[2][1]*T[2][1]/H[1][1];
    T[2][2]+=(H[1][0]*H[2][1]-H[1][1]*H[2][0])*T[2][0]/(H[0][0]*H[1][1]);
    
    T[2][1]*=1.0+H[2][2]/H[1][1];
    T[2][1]-=H[1][0]*H[2][2]*T[2][0]/(H[0][0]*H[1][1]);
    T[2][1]-=H[2][0]*T[1][0]/H[0][0];
    
    T[2][0]*=1.0+H[2][2]/H[0][0];
    T[2][0]+=H[2][1]*T[1][0]/H[0][0];
    
    T[1][0]*=1.0+H[1][1]/H[0][0];*/
    
    T[1][1]-=H[1][0]*T[0][1]/H[0][0];
    
    
    T[2][2]-=(H[1][1]*H[2][0]*T[0][2]-H[1][0]*H[2][1]*T[0][2]+H[0][0]*H[2][1]*T[1][2])/(H[0][0]*H[1][1]);
    
    T[2][1]-=(H[1][1]*H[2][0]*T[0][1]+H[1][0]*H[2][2]*T[0][2]-H[0][0]*H[2][2]*T[1][2])/(H[0][0]*H[1][1]);
    
    T[2][0]+=(H[2][1]*T[0][1]+H[2][2]*T[0][2])/H[0][0];
    
    T[1][0]+=H[1][1]*T[0][1]/H[0][0];
