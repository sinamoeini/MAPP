...
namespace MAPP_NS
{
    ...
    protected:
        ...
        int f_n,type_n,x_n,c_n,E_n,dE_n,
        mu_n,s_n,crd_n,t_n,c_d_n,m_n;
        type0 cut_sq_0;
        type0 cut_sq_mod_0;
        ...
        type0 g_calc_crd(int,type0,type0*,type0*,type0*);
        type0 g_calc_ncrd(int,type0,type0*,type0*,type0*);
        void c_d_calc_crd(int,type0*);
        void c_d_calc_ncrd(int,type0*);
