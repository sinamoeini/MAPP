...
B[2][0]=(A[1][0]==0 || A[2][1]==0) ? (A[2][0]==0 ? 0 : (-A[1][1]*A[2][0])/(A[0][0]*A[1][1]*A[2][2])) : (A[2][0]==0 ? (A[1][0]*A[2][1])/(A[0][0]*A[1][1]*A[2][2]) :(A[1][0]*A[2][1]-A[1][1]*A[2][0])/(A[0][0]*A[1][1]*A[2][2])),\
B[2][1]=-A[2][1]/(A[1][1]*A[2][2]),B[2][2]=1.0/A[2][2])
#define V3MULV3(a,b) a[0]*b[0]+a[1]*b[1]+a[2]*b[2]
