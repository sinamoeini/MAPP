...
{    
    ...
    private:
        ...
        type0 imp_cost_grad_crd(bool,type0,type0,type0,type0*,type0*);
        type0 imp_cost_grad_ncrd(bool,type0,type0,type0,type0*,type0*);
        type0 ddc_norm_crd();
        type0 ddc_norm_ncrd();
    ...
    protected:        
        ...
        type0 ddc_norm();
        type0 imp_cost_grad(bool,type0,type0,type0,type0*,type0*);
