...
/*--------------------------------------------
 ...
 --------------------------------------------*/
inline void DMD_mbdf::ord_dt(type0 m_err,type0& del_t,int& q)
{
    if(init_phase)
    {
        type0 r=2.0;
...
/*--------------------------------------------
 ...
 --------------------------------------------*/
inline void DMD_mbdf::fail_stp_adj(type0 err,type0 m_err,type0& del_t,int& q)
{
    const_stps=0;
    init_phase=false;
    if(max_t-tot_t<=2.0*min_del_t)
